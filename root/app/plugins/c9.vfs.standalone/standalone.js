...
function plugin (options, imports, register) {
  ...
  api.get('/ide.html', {
    ...
    opts.options.extendOptions.user = {
      id: req.headers['x-username'],
      fullname: req.headers['x-username'],
      name: req.headers['x-username'],
      email: `${req.headers['x-username']}@localhost`
    }
  ...
  api.get('/vfs-root', function (req, res, next) {
    if (!options.options.testing) { return next() }
